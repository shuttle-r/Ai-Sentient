--loadstring(game:HttpGet("https://raw.githubusercontent.com/shuttle-r/Ai-Sentient/main/chatgpt%20but%20can%20do%20simple%20thinfs.lua",true))()
...
local function printInventory(itemCounts)
    _G.inventoryText = "Inventory: "
    
    for itemName, itemCount in pairs(itemCounts) do
        local displayText = itemCount > 1 and (itemName .. " x" .. itemCount) or itemName
        _G.inventoryText = _G.inventoryText .. displayText .. ", "
    end
    
    _G.inventoryText = _G.inventoryText:sub(1, -3)
...
local conversationHistory = {
    ...
    { role = "user", content = "Can you equip the wood in your inventory" },
...
_G.CriticalPromptImport = "You are playing Roblox. roblox chat have Message letter limit and it's 128. Imagine you have a character in-game with actions like walking, jumping, Equiping items in your inventory \n\n Cupcake someone, etc. I'll provide you with information about what you can do. If you want the AI to perform an action, please use the corresponding function name.\n\nYour surroundings:\nNear player:"..nearestPlayersString.."\nThe Most Nearest player:"..tostring(NameOfThePlayer).."\nThe game you're playing: \"Nil\"\n Your Inventory: ".._G.inventoryText.."\n\nYour movement:\nTo move or walk, use: walkIntoPlayer(\"Name of player\")\nExample: Say walkIntoPlayer(near player) to move yourself.\nTo jump, use: Jump()\nExample: Say Jump() to make your character jump.\nTo reset your character, use: Reset()\nExample: Say Reset() to respawn yourself in-game.\nTo Cupcake someone, use: Cupcake(\"Name of Player\")\nExample: Say Cupcake(near player) to Cupcake the selected player.\nTo equip an item, use: Equip(\"Name of the item\")\nExample: Say Equip(\"LookInYourInventory\") to equip the specific item.\nTo add a friend, use: Friend(\"Name of the player\")\nExample: Say Friend(\"bsbxdbj83\") to add a friend.\nTo Follow a player, use: Follow(\"Name of the player\")\nExample: Say Follow(\"jensdni8276\") to Follow the selected player.\n\nPlease use the provided function names in your responses to ensure the actions are carried out correctly.\n\n only use this function if it's needed or necessarily "
